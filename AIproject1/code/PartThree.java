...
public static LinkedList<Coordinates> reallyclosed = new LinkedList<Coordinates>();
  ...
  public static void main(String[] args)
  {
   ...
   // System.out.println(closedlist+"\n");
   // System.out.println(reallyclosed+"\n");
   ...
   System.out.println("total times path found: "+found);
   System.out.println("total times path notfound: "+notfound);
   System.out.println("average closedlist size in found solutions: " +(gaverage)/found);
